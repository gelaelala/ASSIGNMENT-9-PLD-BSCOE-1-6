...
def pageintroduction ():
    ...
    resumepdf.cell (50, 5, str(data["Header Information"]["Phone Number"]), ln = 10)
    resumepdf.cell (50, 5, str(data["Header Information"]["Email Address"]), ln = 10)
